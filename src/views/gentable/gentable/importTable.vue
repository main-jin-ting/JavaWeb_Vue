<template>
  <!-- 导入表 -->
  <el-dialog title="导入表" :visible.sync="visible" width="80%" top="5vh">
...
export default {
  ...
  methods: {
    ...
    // 查询表数据
    getList() {
      gentableApi.genDbTableList(this.queryParams).then(res => {
    ...
    /** 导入按钮操作 */
    handleImportTable() {
      gentableApi.importTable(this.tables.join(",")).then(res => {
