  ...
  <div class="info-form">
    <el-form ref="infoForm" :model="infoForm" size="small" label-width="100px">
      <el-form-item label="角色名称" prop="name" :rules="[{
                  ...
                  },{min: 2, max: 20, message: '角色名称长度在2 到 20 个字符', trigger: 'blur'}]">
        <el-input maxlength="20" clearable v-model="infoForm.name" size="small" placeholder="请输入角色名称"/>
      </el-form-item>
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            roleApi[method](this.infoForm).then(res => {
